...
REPO_ROOT=""
REPO_GIT_URL="${VISGNITEAI_REPO_URL:-https://github.com/PhamTy2002z/Project-VisgniteAI.git}"
REPO_CLONE_REF="${VISGNITEAI_REPO_REF:-}"
REPO_DIR_NAME="Project-VisgniteAI"
STATE_DIR="${XDG_STATE_HOME:-$HOME/.local/state}"
LOG_DIR="$STATE_DIR/visgniteai-install"
