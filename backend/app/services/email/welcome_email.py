...
def build_welcome_email(
    ...
    subject = f"Welcome to VisgniteAI, {name}!"
    text = (
        f"Hi {name},\n\n"
        "Welcome to VisgniteAI! We're glad you're here.\n\n"
        "VisgniteAI helps you orchestrate AI agents, manage boards, "
    ...
    html = (
        ...
        "Thanks for joining VisgniteAI! We built this platform to help teams "
        ...
        "You received this because you signed up for VisgniteAI. "
