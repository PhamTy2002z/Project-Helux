 ...
 */
export type rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponse200 = {
  data: RotateAgentTokenApiV1AgentsAgentIdRotateTokenPost200;
  status: 200;
};

export type rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponse422 = {
  data: HTTPValidationError;
  status: 422;
};

export type rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponseSuccess =
  rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponse200 & {
    headers: Headers;
  };
export type rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponseError =
  rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponse422 & {
    headers: Headers;
  };

export type rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponse =
  | rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponseSuccess
  | rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponseError;

export const getRotateAgentTokenApiV1AgentsAgentIdRotateTokenPostUrl = (
  agentId: string,
) => {
  return `/api/v1/agents/${agentId}/rotate-token`;
};

export const rotateAgentTokenApiV1AgentsAgentIdRotateTokenPost = async (
  agentId: string,
  options?: RequestInit,
): Promise<rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponse> => {
  return customFetch<rotateAgentTokenApiV1AgentsAgentIdRotateTokenPostResponse>(
    getRotateAgentTokenApiV1AgentsAgentIdRotateTokenPostUrl(agentId),
    {
      ...options,
      method: "POST",
    },
...
export const getRotateAgentTokenApiV1AgentsAgentIdRotateTokenPostMutationOptions =
  <TError = HTTPValidationError, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
      Awaited<
        ReturnType<typeof rotateAgentTokenApiV1AgentsAgentIdRotateTokenPost>
      >,
      TError,
      { agentId: string },
      TContext
    ...
    TContext
  > => {
    const mutationKey = ["rotateAgentTokenApiV1AgentsAgentIdRotateTokenPost"];
    const { mutation: mutationOptions, request: requestOptions } = options
      ? options.mutation &&
        "mutationKey" in options.mutation &&
        options.mutation.mutationKey
    ...
    > = (props) => {
      ...
      return rotateAgentTokenApiV1AgentsAgentIdRotateTokenPost(
        agentId,
        requestOptions,
      );
    };
...
export type RotateAgentTokenApiV1AgentsAgentIdRotateTokenPostMutationResult =
  NonNullable<
    Awaited<
      ReturnType<typeof rotateAgentTokenApiV1AgentsAgentIdRotateTokenPost>
    >
...
export type RotateAgentTokenApiV1AgentsAgentIdRotateTokenPostMutationError =
  HTTPValidationError;

/**
 * @summary Rotate Agent Token
 */
export const useRotateAgentTokenApiV1AgentsAgentIdRotateTokenPost = <
  TError = HTTPValidationError,
  TContext = unknown,
>(
  options?: {
  ...
  Awaited<ReturnType<typeof rotateAgentTokenApiV1AgentsAgentIdRotateTokenPost>>,
  TError,
  { agentId: string },
  TContext
> => {
  return useMutation(
    getRotateAgentTokenApiV1AgentsAgentIdRotateTokenPostMutationOptions(
      options,
    ),
    queryClient,
  );
