...
export type GatewaySnapshot = GatewayTarget & {
  connected: boolean;
...
export const DASH = "—";
export const DASHBOARD_RANGE = "7d";
export const DASHBOARD_RANGE_DAYS = 7;
export const DASHBOARD_RANGE_LABEL = "7 days";
...
export const toSessionSummaries = (
