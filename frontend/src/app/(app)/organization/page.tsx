  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <div className="mt-3 inline-flex rounded-xl border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-1">
          <button
            type="button"
            className={cn(
      ...
      {scope === "all" ? (
        <div className="flex flex-wrap items-center gap-6 rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-2.5 text-sm">
          <label className="flex items-center gap-2 text-[color:var(--text-muted)]">
            <input
              type="checkbox"
              className="h-4 w-4"
              checked={allRead}
