...
function GroupChatMessageCard({ message }: { message: BoardGroupMemoryRead }) {
  return (
    <div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-3 shadow-sm">
      ...
      <div className="mt-1 select-text cursor-text text-sm leading-6 text-strong break-words">
        <LazyMarkdown content={message.content} variant="basic" />
      </div>
      {message.tags?.length ? (
        <div className="mt-2.5 flex flex-wrap gap-2 text-[11px] text-[color:var(--text-muted)]">
          {message.tags.map((tag) => (
            <span
              key={tag}
              className="rounded-full border border-[color:var(--border)] bg-[color:var(--surface-muted)] px-2 py-0.5"
            >
              {tag}
            </span>
          ))}
            ...
            <div className="px-8 py-6">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3">
                <label className="inline-flex items-center gap-2 text-sm text-[color:var(--text)]">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-[color:var(--border-strong)] text-blue-600"
                    checked={includeDone}
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          perBoardLimit === value
                            ...
                            : "text-[color:var(--text-muted)] hover:bg-[color:var(--surface-muted)] hover:text-strong",
                        )}
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm text-[color:var(--text)]">
                  ...
                  <label className="inline-flex items-center gap-2 text-xs text-[color:var(--text)]">
                    <input
                      type="checkbox"
                      className="h-4 w-4 rounded border-[color:var(--border-strong)] text-blue-600"
                      ...
                      <div className="border-b border-[color:var(--border)] px-6 py-4">
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex flex-wrap items-center justify-end gap-2 text-xs">
                            <span className="rounded-full border border-[color:var(--border)] bg-[color:var(--surface-muted)] px-2 py-0.5 text-[color:var(--text)]">
                            ...
                            {item.tasks.map((task) => (
                              <li key={task.id}>
                                <Link
                                  ...
                                  className="block rounded-lg border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-3 transition hover:border-blue-200 hover:bg-blue-50/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex flex-1 flex-col overflow-hidden px-6 py-4">
            ...
            <div className="flex-1 space-y-3 overflow-y-auto rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-4">
