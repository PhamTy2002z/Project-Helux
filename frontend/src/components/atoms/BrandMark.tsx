    ...
    return (
      ...
      >
        <Image
          ...
          priority
        />
        <span className="absolute inset-0 flex items-center justify-center rounded-xl bg-[color:var(--surface-muted)] text-muted opacity-0 transition-opacity duration-150 group-hover:opacity-100">
  ...
  return (
    <div className="flex w-full items-center justify-between">
      ...
      <button
        ...
        className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg text-quiet transition-colors duration-150 hover:bg-[color:var(--surface-muted)] hover:text-[color:var(--text-muted)] active:scale-95"
      >
