  ...
  return (
    <div className="relative">
      <Select value={orgValue} onValueChange={handleOrgChange}>
        <SelectTrigger className="h-9 w-[220px] rounded-md border-[color:var(--border)] bg-[color:var(--surface)] px-3 text-sm font-medium text-strong shadow-none focus:ring-offset-0">
        ...
        <SelectContent className="min-w-[220px] rounded-md border-[color:var(--border)] p-1 shadow-xl">
          ...
          {orgs.length ? (
            orgs.map((org) => (
              <SelectItem
                key={org.id}
                value={org.id}
                className="rounded-md py-2 pl-7 pr-3 text-sm text-[color:var(--text)] data-[state=checked]:bg-[color:var(--surface-muted)] data-[state=checked]:text-strong focus:bg-[color:var(--surface-muted)]"
              >
                {org.name}
              </SelectItem>
            ))
            ...
            <SelectItem
              value={orgValue}
              className="rounded-md py-2 pl-7 pr-3 text-sm text-[color:var(--text)]"
            >
              Organization
            </SelectItem>
          )}
          ...
          <SelectItem
            value="__create__"
            className="rounded-md py-2 pl-3 pr-3 text-sm font-medium text-[color:var(--text-muted)] hover:text-strong focus:bg-[color:var(--surface-muted)] [&>span:first-child]:hidden"
          >
            <span className="flex items-center gap-2">
