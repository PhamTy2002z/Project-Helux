      ...
      <div className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="text-xs font-medium text-muted underline underline-offset-2 transition hover:text-[color:var(--text)] disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-end">
          ...
          <div className="space-y-2">
            ...
            <div className="inline-flex h-11 items-center gap-2 rounded-lg border border-[color:var(--border)] bg-[color:var(--surface)] px-3">
              <span
