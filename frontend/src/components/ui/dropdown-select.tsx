            ...
            {options.map((option) => {
              ...
              return (
                <CommandItem
                  ...
                  className={cn(
                    "flex items-center justify-between gap-2 rounded-lg px-4 py-3 text-sm text-[color:var(--text)] transition-colors data-[selected=true]:bg-[color:var(--surface-muted)] data-[selected=true]:text-strong",
