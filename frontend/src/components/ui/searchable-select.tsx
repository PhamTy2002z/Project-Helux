...
const baseItemClassName =
  "px-4 py-3 text-sm text-[color:var(--text)] transition-colors data-[selected=true]:bg-[color:var(--surface-muted)] data-[selected=true]:text-strong data-[selected=true]:font-semibold hover:bg-[color:var(--surface-muted)]";
