...
function riskPillClassName(risk: string | null | undefined) {
  ...
  switch (normalizedRisk) {
    ...
    case "unknown":
      return "bg-[color:rgba(148,163,184,0.16)] text-[color:var(--text)] border border-[color:var(--border)]";
    default:
        ...
        cell: ({ row }) => {
          ...
          return (
            <Link
              ...
              className="inline-flex items-center gap-1 text-sm font-medium text-[color:var(--text)] hover:text-blue-600"
            >
        ...
        cell: ({ row }) => {
          ...
          return (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="text-sm font-medium text-[color:var(--text)] hover:text-blue-600 hover:underline"
              title={sourceHref}
            >
              ...
              {installedOn.map((gateway, index) => {
                ...
                return (
                  <span
                    ...
                    className="inline-flex items-center gap-1 text-sm text-[color:var(--text)]"
                    title={gateway.name}
                  >
                    {gateway.name}
                    {!isLast ? "," : ""}
