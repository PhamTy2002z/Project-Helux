    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          if (row.original.kind === "member") {
            ...
            return (
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 text-xs font-semibold text-white">
                  {display.initials}
                </div>
                <div>
          ...
          return (
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[color:var(--surface-strong)] text-xs font-semibold text-[color:var(--text-muted)]">
